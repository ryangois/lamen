...
export const catalog = ringStructure.map((ring) => ({
  ...
  items: ring.segments.map((segment) => {
    ...
    const searchable = normalize([
      ...
      content.psalm?.hebrewReference,
      content.psalm?.hebrew,
      content.psalm?.transliteration,
      content.psalm?.text,
      content.psalm?.title,
      content.psalm?.note,
      content.psalm?.meditation,
      content.psalm?.source,
      content.gematria?.core?.text,
      content.gematria?.core?.value,
      content.gematria?.core?.formula,
      content.gematria?.full?.text,
      content.gematria?.full?.value,
      content.gematria?.full?.formula,
      content.gematria?.method,
      content.gematria?.interpretations?.join(' '),
