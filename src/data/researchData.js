...
export const HEBREW_LETTERS = [
  ['Aleph', 'א', 1, 'boi, força ou princípio'],
  ['Beth', 'ב', 2, 'casa ou interior'],
  ['Gimel', 'ג', 3, 'camelo, travessia ou movimento'],
  ['Daleth', 'ד', 4, 'porta ou passagem'],
  ['Heh', 'ה', 5, 'janela, sopro ou revelação'],
  ['Vav', 'ו', 6, 'gancho ou ligação'],
  ['Zayin', 'ז', 7, 'arma ou discriminação'],
  ['Cheth', 'ח', 8, 'cerca, recinto ou vida'],
  ['Teth', 'ט', 9, 'recipiente ou potência recolhida'],
  ['Yod', 'י', 10, 'mão ou ponto seminal'],
  ['Kaph', 'כ', 20, 'palma da mão ou capacidade'],
  ['Lamed', 'ל', 30, 'aguilhão ou aprendizado'],
  ['Mem', 'מ', 40, 'água'],
  ['Nun', 'נ', 50, 'continuidade, broto ou peixe'],
  ['Samekh', 'ס', 60, 'apoio ou sustentação'],
  ['Ayin', 'ע', 70, 'olho ou percepção'],
  ['Peh', 'פ', 80, 'boca ou expressão'],
  ['Tzaddi', 'צ', 90, 'gancho, justiça ou retidão'],
  ['Qoph', 'ק', 100, 'nuca, horizonte ou imitação'],
  ['Resh', 'ר', 200, 'cabeça ou princípio'],
  ['Shin', 'ש', 300, 'dente, fogo ou transformação'],
  ['Tav', 'ת', 400, 'marca, sinal ou selo'],
].map(([name, hebrew, value, image]) => ({ name, hebrew, value, image }));
